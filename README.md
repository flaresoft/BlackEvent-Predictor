...
"외부충격은 예측 불가"라는 통념과 달리, 141건의 BlackEvent 분석 결과 **위기 유형에 따라 예측력이 명확히 구분**된다.

| 유형 | 사전 신호 | 사례 | 모델 성능 |
|------|:---:|------|------|
| 지정학적/구조적 위기 | O | 이란(2026), 리먼(2008), 유럽위기(2011) | **수 주 전 WARNING 발령** |
| 시장 기술적 충격 | X | 2024-08 급락, 2018 VIX쇼크 | 사전 감지 불가 |
| 신종 위협 | △ | COVID(2020) | 초기 미감지, 진행 중 감지 |

지정학적 위기는 외교적 긴장, 공급망 우려, 정책 불확실성이 뉴스에 수 주간 축적되며, 모델은 이 구조적 패턴을 포착한다. "갑작스러운 외부충격"으로 보이는 사건의 대부분은 실제로 뉴스에 사전 흔적을 남긴다.

**신호 중첩 깊이와 회복탄력성**: 극강 신호(ratio > 1.5)의 동시 발현 수가 위기 심각도와 회복 기간을 예측한다.

| 극강 신호 수 | 사례 | 회복 패턴 |
|:---:|------|------|
| 1개 | COVID(2020) | V자 회복 (~5개월) |
| 8~10개 | 유럽위기(2011), 리먼(2008) | L/W자, 6~18개월 연쇄 붕괴 |

> 분석 상세: [`data/outputs/insight_2026-03-04_iran_crisis.md`](data/outputs/insight_2026-03-04_iran_crisis.md)
